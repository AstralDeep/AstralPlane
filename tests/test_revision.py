...
def test_schema_lineage_and_lock_identities_bind_the_canonical_registry() -> None:
    ...
    assert SCHEMA_PREDECESSOR_REVISION == "079.001"
    assert SCHEMA_REVISION == "088.001"
    ...
    assert migrations_module.PLANE_SCHEMA_088_MIGRATION.source_revisions == (
        SCHEMA_PREDECESSOR_REVISION,
    )
    assert migrations_module.PLANE_SCHEMA_088_MIGRATION.target_revision == SCHEMA_REVISION
